...
if __name__ == '__main__':
    ...
    ssh_command = 'ssh {}'.format(ssh_target)
    ...
    rsync_image_command = 'rsync --verbose -r {} {}:{}'.format(source_image_dir, ssh_target, tmp_dir)
    ...
    rsync_image_command = 'rsync --verbose {}:{} ./{}'.format(
