...
mkdir -p ~/ros/semi2025/src
cd ~/ros/semi2025/src
wget https://raw.githubusercontent.com/iory/jsk_demos/refs/heads/semi2025/semi2025/vcsinstall.noetic -O- | vcs import
cd ~/ros/semi2025
rosdep install --from-paths -i -y -r .
catkin build --cmake-args -DCMAKE_BUILD_TYPE=Release
source ~/ros/semi2025/devel/setup.bash
```
